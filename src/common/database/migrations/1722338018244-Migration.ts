...
export class Migration1722338018244 implements MigrationInterface {
    name = 'Migration1722338018244'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "technicians" ADD "image_key" character varying(100)`);
        await queryRunner.query(`ALTER TABLE "technicians" ADD "image_url" character varying(100)`);
        await queryRunner.query(`ALTER TABLE "technicians" ADD "license_plate" character varying(10)`);
